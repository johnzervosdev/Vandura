...
*Last Updated: 2026-05-06 — Story **6.3** ✅ (`tasks.story_number`, **`task.listByProject`** sort, **`localStorage`**); Story **6.2** ✅; Epic 8 Story **8.1** shipped; **BUG-REPORT-001** / **Story 6.7** ✅; Story 6.1 `taskEstimatesTotal`; Story 7.1 import policy (planned).*
